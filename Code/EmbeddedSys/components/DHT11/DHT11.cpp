...
DHT11::DHT11(RaspberryPi& RaspberryPi, int GpioPin)
...
DHT11::CData DHT11::ProcessData(uint64_t Data)
{
...
uint8_t DHT11::CalculateParity(uint8_t HumidityHigh, uint8_t HumidityLow, uint8_t TemperatureHigh, uint8_t TemperatureLow)
{
